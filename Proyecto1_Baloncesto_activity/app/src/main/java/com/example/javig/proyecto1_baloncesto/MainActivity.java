...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView marcador1,marcador2,idLocal,idVisitante;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idLocal = (TextView) findViewById(R.id.tvLocal);
        idVisitante = (TextView) findViewById(R.id.tvVisitante);
        ...
        if(bundle != null){
            idLocal.setText(bundle.getString("local"));
            idVisitante.setText(bundle.getString("visitante"));
        }
